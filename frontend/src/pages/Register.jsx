...
import { authAPI } from '../api.js'; // CORRECT: Import the authAPI object for registration
...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // CORRECT: Access the register method from the imported authAPI object.
      await authAPI.register({ username, email, password });
      
      // If registration is successful, automatically log the user in.
      // This assumes your register endpoint does not return a token directly for auto-login.
      const loggedIn = await login({ username, password }); 

      if (loggedIn) {
        // You should avoid using window.alert() in React applications for better UX.
        // Consider using a state-managed modal or toast notification library.
        alert('Registration successful! You are now logged in.'); 
        // Navigation to dashboard is handled by the login function in AuthContext.
      } else {
